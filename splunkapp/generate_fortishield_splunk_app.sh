...
# Program to build the Fortishield App for Splunk
...
BRANCH_TAG=""
SPLUNK_VERSION=""
CONTAINER_NAME="fortishield-splunk-app-builder"
OUTDIR="${CURRENT_PATH}/output"
CHECKSUMDIR=""
REVISION=""
REPOSITORY="fortishield-splunk"
...
build_package() {
    ...
    docker run -t --rm -v ${OUTDIR}:/fortishield_splunk_app:Z \
