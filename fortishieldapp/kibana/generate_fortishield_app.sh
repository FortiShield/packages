...
# Program to build the Fortishield App for Kibana
...
BRANCH_TAG=""
CHECKSUMDIR=""
CONTAINER_NAME="fortishield-kibana-app-builder"
...
help() {
    ...
    echo "    -s, --store <path>        [Optional] Set the destination path of package, by default /tmp/fortishield-app."
...
build_package(){
    ...
    # Build the Fortishield Kibana app package using the build docker image
